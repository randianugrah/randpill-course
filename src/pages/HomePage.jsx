          ...
          <Row className="header-box align-items-center pt-lg-5">
            <Col lg="6">
              ...
              <p className="mb-4 animate__animated animate__fadeInUp animate__delay-1s">
                ...
                Aliquid illo, doloribus consequatur facere vitae quos.
              </p>
              <button
                className="btn btn-danger rounded-1 me-2 mb-xs-0 mb-2 animate__animated animate__fadeInUp animate__delay-1s"
                onClick={() => navigate("/website-course/kelas")}
              >
                Lihat Kelas
              </button>
              <button className="btn btn-outline-danger rounded-1 mb-2 animate__animated animate__fadeInUp animate__delay-1s">
                Lihat Promo
              </button>
            </Col>
